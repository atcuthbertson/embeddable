...
// significantly altered to make this appropriate for embedding in another web page.  Simplified design and functionality.
// Last edited 20150701 Aaron Cuthbertson.  DWR DIRWM NCRO.  aaron.cuthbertson@water.ca.gov
...
function(
  ...
  ready(function() {
    ...
    closeToggle.hidePane(); // rightpane closed on load
	
    on(closeButton, "mousedown", closeToggle.toggle);
	// Legend toggle
	 //var legTog = new LegendToggle(map, "leftPane");
    var legTog = new LegendToggle(map, closeToggle.toggle);
    ...
    CheckLayer("https://darcgis.water.ca.gov/arcgis/rest/services/cadre/GSAs/MapServer",
      map,
      hookServiceToTab,
      {
        //excludeLegends:true,
        ...
        excludeDownload:["*"],
		startEnabled:["Groundwater_Sustainability_Agencies"]
